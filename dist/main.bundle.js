...
var AppComponent = (function () {
    ...
    AppComponent.prototype.search = function () {
        var _this = this;
        console.log("called");
        this.weather.searchWeather(this.city).subscribe(function (data) {
            _this.climate = data.weather[0].main;
...
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["l" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__weather_service__["a" /* Weather */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__weather_service__["a" /* Weather */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__weather_service__["a" /* Weather */]) === "function" && _a || Object])
], AppComponent);
...
var Weather = (function () {
    function Weather(http, jsonp) {
        this.http = http;
        this.jsonp = jsonp;
    }
    Weather.prototype.searchWeather = function (city) {
        var weather_url = "http://samples.openweathermap.org/data/2.5/weather?q=" + city + "&appid=39afc12796a84076e584817de42b34ae";
